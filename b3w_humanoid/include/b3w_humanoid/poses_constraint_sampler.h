...
namespace b3w_humanoid{
  ...
  public:
    ...
    void callbackfn(robot_state::RobotState& state,const geometry_msgs::Pose& ik_pose, const std::vector<double>& ik_solution, moveit_msgs::MoveItErrorCodes& error_code);
  protected:
